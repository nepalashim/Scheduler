...
import { NewestClass } from "../data/index";
      ...
      <header className="w-100 min-vh-100 d-flex align-items-center">
        <Container>
          <Row className="header-box d-flex align-items-center">
            ...
            <button className="btn btn-success btn-lg rounded-1 me-2 mb-xs-0 mb-2">See anything ...</button>
            <button className="btn btn-outline-success btn-lg rounded-1 mb-xs-0 mb-2 ">See anything..</button>
            </Col>
      ...
      <div className="class w-100 min-vh-100">
        <Container>
          ...
          <Row>
            ...
            <button className="btn btn-success rounded-5 btn-lg" onClick={() => navigate("/class")}> See All Listings 
